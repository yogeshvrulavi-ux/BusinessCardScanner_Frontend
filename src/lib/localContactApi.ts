...
export function localContactToPayload(contact: LocalContact): LeadPayload {
  return {
    ...
    countryCode: String((contact as { countryCode?: string }).countryCode || ""),
    countryName: String((contact as { countryName?: string }).countryName || ""),
    phone: contact.phone || "",
    ...
    eventDay: String((contact as { eventDay?: string }).eventDay || ""),
