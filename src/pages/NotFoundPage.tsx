  ...
  return (
    <div className="flex min-h-[calc(100vh-8rem)] flex-col items-center justify-center px-4 py-10 sm:py-14">
      <div className="mx-auto w-full max-w-2xl text-center">
        <div className="relative mx-auto mb-8 max-w-xl overflow-hidden rounded-3xl border border-border/60 bg-gradient-to-br from-primary/10 via-card to-cyan-500/10 p-2 shadow-elevated">
          <div className="pointer-events-none absolute -right-8 -top-8 h-32 w-32 rounded-full bg-primary/20 blur-3xl" />
          <div className="pointer-events-none absolute -bottom-10 -left-10 h-36 w-36 rounded-full bg-teal-500/15 blur-3xl" />
          <img
        ...
        <p className="font-display text-8xl font-bold tracking-tighter text-transparent bg-gradient-to-br from-primary via-teal-500 to-cyan-600 bg-clip-text sm:text-9xl">
          404
        </p>
