      ...
      <PageShell
        ...
        actions={
          <div className="flex flex-wrap gap-2">
            ...
            <Button onClick={() => setInviteOpen(true)} className="h-10 rounded-xl bg-gradient-primary">
        ...
        <Card className="rounded-2xl border-border/60 p-4 shadow-soft sm:p-6">
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <Button className="mt-5 rounded-xl bg-gradient-primary" onClick={() => setInviteOpen(true)}>
                <Plus className="mr-2 h-4 w-4" />
                Send invitation
              </Button>
            </div>
