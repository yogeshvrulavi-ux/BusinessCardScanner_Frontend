...
import { Loader2, Plus, Save, KeyRound, Search, User, UserCheck, UserX, Pencil, Trash2, RefreshCw } from "lucide-react";
import { P as PageShell, C as Card } from "./PageShell-CBDc5a2k.js";
import { u as useAuth, I as Input, B as Button, A as AuthGate, a as useConfirmModal } from "./router-BZi1TmQF.js";
import { B as Badge } from "./badge-lFC_rMe_.js";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogDescription, L as Label, e as DialogFooter } from "./label-BGm20A1y.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-CO4DQJuM.js";
import { toast } from "sonner";
import { f as fetchCompanies, c as createUser, u as updateUser, a as adminResetPassword, b as fetchUsers, d as updateUserStatus, e as deleteUser } from "./adminApi-DxZgTLsH.js";
import { S as Switch } from "./switch-CLG5pcBr.js";
...
function CreateUserModal({ open, onOpenChange, onSuccess }) {
  ...
  useEffect(() => {
    ...
    fetchCompanies(1, 200).then((res) => setCompanies(res.items)).catch(() => toast.error("Failed to load companies.")).finally(() => setIsLoadingCompanies(false));
  }, [open, isSuperAdmin]);
  useEffect(() => {
  ...
  return /* @__PURE__ */ jsx(Dialog, { open, onOpenChange: (v) => {
    ...
    /* @__PURE__ */ jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsx(DialogTitle, { children: "Create User" }),
      /* @__PURE__ */ jsx(DialogDescription, { children: isSuperAdmin ? "Create a new user and assign them to a company." : "Create a new user in your company." })
    ] }),
    /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          isSuperAdmin ? /* @__PURE__ */ jsxs(Select, { value: form.role, onValueChange: (v) => set("role", v), children: [
            /* @__PURE__ */ jsx(SelectTrigger, { className: "w-full", children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Select role" }) }),
            /* @__PURE__ */ jsx(SelectContent, { children: ROLES$1.map((r) => /* @__PURE__ */ jsx(SelectItem, { value: r.value, children: r.label }, r.value)) })
          ] }) : /* @__PURE__ */ jsx("div", { className: "flex h-9 items-center rounded-md border border-input bg-muted/30 px-3 text-sm text-muted-foreground", children: "User" })
        ] }),
        isSuperAdmin && /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(Label, { children: "Company *" }),
          isLoadingCompanies ? /* @__PURE__ */ jsxs("div", { className: "flex h-9 items-center gap-2 rounded-md border border-input px-3 text-sm text-muted-foreground", children: [
            ...
            Select,
            {
              ...
              children: [
                /* @__PURE__ */ jsx(SelectTrigger, { className: "w-full", children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Select company" }) }),
                /* @__PURE__ */ jsx(SelectContent, { children: companies.map((c) => /* @__PURE__ */ jsx(SelectItem, { value: c.id, children: c.company_name }, c.id)) })
              ]
            }
          )
        ] })
      ...
      PageShell,
      {
        ...
        children: /* @__PURE__ */ jsxs(Card, { className: "rounded-2xl border-border/60 p-4 shadow-soft sm:p-6", children: [
          ...
          isLoading ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-16", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "mt-1 max-w-xs text-sm text-muted-foreground", children: "Create your first user to get started." }),
            /* @__PURE__ */ jsxs(
              Button,
              {
