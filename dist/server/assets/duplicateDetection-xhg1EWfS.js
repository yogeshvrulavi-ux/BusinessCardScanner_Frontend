import { a3 as listStoredContacts } from "./router-B3QH6PKy.js";
...
async function checkForDuplicates(payload) {
  if (typeof navigator === "undefined" || navigator.onLine) {
    try {
      const { API_BASE_URL } = await import("./router-B3QH6PKy.js").then((n) => n.a5);
      const { apiFetch } = await import("./router-B3QH6PKy.js").then((n) => n.a4);
  ...
  try {
    const { getQueueItems } = await import("./router-B3QH6PKy.js").then((n) => n.a6);
