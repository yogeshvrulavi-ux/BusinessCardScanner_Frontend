...
import { b as getCurrentAppUser, c as apiFetch, d as API_BASE_URL, e as clearUserBrowserData, f as clearOutreachStatusForUser, i as invalidateContactsDirectory, I as Input, T as TIMEZONE_OPTIONS, B as Button, h as cn, j as loadUserSettings, D as DEFAULT_USER_SETTINGS, s as saveUserSettings, a as useConfirmModal, u as useAuth, k as getUserInitials, m as hasCookieConsent, P as PAGE, n as applyWorkModePreference, o as saveCookieConsent } from "./router-DJrz5rEK.js";
import { C as Card, P as PageShell } from "./PageShell-CAiM-dst.js";
import { S as Switch } from "./switch-CA3Yb-s2.js";
import { L as Label } from "./label-CYxZdC0e.js";
import { S as Select, e as SelectTrigger, f as SelectValue, g as SelectContent, h as SelectItem, D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogDescription, i as DialogFooter } from "./select-Cyqtf15t.js";
import { C as COOKIE_POLICY_SECTIONS, L as LEGAL_PAGE_URLS } from "./legalContent-BC1YLxXm.js";
...
async function clearLocalQueueOnly() {
  const appUser = await getCurrentAppUser();
  const { clearUserSyncQueue } = await import("./router-DJrz5rEK.js").then((n) => n.a9);
...
function ProfileSettingsCard({
  ...
  return /* @__PURE__ */ jsxs(Card, { className: "overflow-hidden rounded-2xl border-border/60 shadow-soft lg:col-span-2", children: [
    /* @__PURE__ */ jsx("div", { className: "relative border-b border-border/60 bg-gradient-to-br from-primary/8 via-card to-cyan-500/5 px-5 py-6 sm:px-8 sm:py-8", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-5 sm:flex-row sm:items-center sm:gap-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "relative mx-auto shrink-0 sm:mx-0", children: [
        /* @__PURE__ */ jsx("div", { className: "flex h-20 w-20 items-center justify-center rounded-md bg-gradient-primary text-2xl font-semibold text-primary-foreground shadow-glow sm:h-24 sm:w-24", children: initials }),
...
function SettingsPage() {
  ...
  const handleWipeAll = async () => {
    const ok = await confirm({
      ...
      description: "Remove your contacts, queue, and outreach status on this device. Records are soft-deleted for audit and recovery.",
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid gap-5 lg:grid-cols-2", children: [
            ...
            SettingRow,
            {
              ...
              onCheckedChange: (v) => {
                ...
                if (v && typeof navigator !== "undefined" && navigator.onLine) {
                  void import("./router-DJrz5rEK.js").then((n) => n.aa).then(
                    ({ maybeAutoSyncWhenOnline }) => maybeAutoSyncWhenOnline().then((summary) => {
      ...
      /* @__PURE__ */ jsxs(Card, { className: "flex h-full flex-col rounded-2xl border-border/60 p-6 shadow-soft", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-5 flex flex-wrap gap-2", children: [
          /* @__PURE__ */ jsx(Button, { variant: "outline", size: "sm", className: "rounded-md", asChild: true, children: /* @__PURE__ */ jsxs(
            "a",
            {
