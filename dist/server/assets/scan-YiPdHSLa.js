...
import { p as getConnectionMode, q as useUserSettings, C as CONNECTION_MODE_CHANGED, P as PAGE, B as Button, r as getCachedContacts, g as getQueueItems, l as listContacts, t as cacheContacts, j as loadUserSettings } from "./router-Bh1EUmi_.js";
...
const CameraCapture = lazy(
  () => import("./CameraCapture-BToN3-oJ.js").then((m) => ({ default: m.CameraCapture }))
);
function ScanPage() {
  ...
  const runScanPipeline = async (activeFile, activePreview, autoNavigate) => {
    ...
    try {
      ...
      const { scanFileAndStore } = await import("./scanPipeline-cxxwGhHf.js").then((n) => n.a);
