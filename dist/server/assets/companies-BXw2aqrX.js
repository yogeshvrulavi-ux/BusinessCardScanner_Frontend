...
import { Loader2, Mail, Building2, Plus, Trash2, RefreshCw } from "lucide-react";
import { P as PageShell, C as Card } from "./PageShell-HUvi-Gj1.js";
import { I as Input, B as Button, A as AuthGate, a as useConfirmModal } from "./router-Bh1EUmi_.js";
import { B as Badge } from "./badge-Df_zPO9H.js";
...
import { h as createCompany, i as fetchCompanies, j as deleteCompany } from "./adminApi-dUj9P00y.js";
...
function CreateCompanyModal({ open, onOpenChange, onSuccess }) {
  ...
  return /* @__PURE__ */ jsx(Dialog, { open, onOpenChange: (v) => {
    ...
    /* @__PURE__ */ jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsx(DialogTitle, { children: "Invite company Admin" }),
      /* @__PURE__ */ jsx(DialogDescription, { children: "Assign organization details and the Admin's email only. Do not set a password — they complete registration from the invitation link before they can log in." })
    ] }),
    /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "email", children: "Company Email" }),
            /* @__PURE__ */ jsx(
              Input,
              {
                id: "email",
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold uppercase tracking-wider text-muted-foreground", children: "Admin invitation" }),
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "mt-1.5 text-xs text-muted-foreground", children: "No password is set here — the Admin creates their own account from the invite email." })
        ] })
      ] }),
