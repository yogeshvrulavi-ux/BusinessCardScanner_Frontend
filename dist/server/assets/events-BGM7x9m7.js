...
import { F as loadEvents, S as Route, U as useContactsDirectory, V as purgeOrphanExampleEvent, P as PAGE, I as Input, y as getExampleEventName, B as Button, e as cn, W as rememberEvent, X as contactRowKey, i as invalidateContactsDirectory } from "./router-CElpkivw.js";
...
function EventContactsTable({ contacts }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "space-y-3 lg:hidden", children: contacts.map((contact) => /* @__PURE__ */ jsxs(Card, { className: "rounded-xl border-border/60 p-4", children: [
      /* @__PURE__ */ jsx("div", { className: "font-medium", children: contact.name }),
      ...
      children: [
        ...
        fetchFailed ? /* @__PURE__ */ jsxs(Card, { className: "flex items-center gap-3 rounded-2xl border-amber-500/40 bg-amber-500/10 px-4 py-3 text-sm", children: [
          ...
          /* @__PURE__ */ jsxs("span", { children: [
            "Could not load leads from Zoho. Wait a minute, then click ",
        ...
        /* @__PURE__ */ jsxs(Card, { className: "rounded-2xl border-border/60 p-4 shadow-soft sm:p-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "mb-5 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Folders come from Zoho Features column and pending saves. Refresh to pull latest from CRM." })
            ] }),
          ...
          showInitialLoading ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center py-16 text-center text-sm text-muted-foreground", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: fetchFailed ? "Zoho could not be reached. Click Refresh after a minute." : contacts.length > 0 ? "Leads loaded but no event name found. In Zoho, Features should show Event: YourEventName (e.g. Event: Mall Opening)." : "Save a card with an event name on Review, then click Refresh." })
