...
import { Sparkles, Trash2, X, CheckCircle2, Loader2, ScanLine, Upload, FileImage, Camera } from "lucide-react";
import { P as PageShell, C as Card } from "./PageShell-DdPA0nbc.js";
import { p as getConnectionMode, q as useUserSettings, C as CONNECTION_MODE_CHANGED, P as PAGE, B as Button, r as getCachedContacts, g as getQueueItems, l as listContacts, t as cacheContacts, j as loadUserSettings } from "./router-B3QH6PKy.js";
...
const CameraCapture = lazy(
  () => import("./CameraCapture-DComEypM.js").then((m) => ({ default: m.CameraCapture }))
);
...
function ScanPage() {
  ...
  const runScanPipeline = async (activeFile, activePreview, autoNavigate) => {
    ...
    try {
      ...
      const { scanFileAndStore } = await import("./scanPipeline-DbQCc__t.js").then((n) => n.a);
