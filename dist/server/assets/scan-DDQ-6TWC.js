...
import { p as getConnectionMode, q as useUserSettings, C as CONNECTION_MODE_CHANGED, P as PAGE, B as Button, r as getCachedContacts, g as getQueueItems, l as listContacts, t as cacheContacts, j as loadUserSettings } from "./router-Dkk-a0yt.js";
...
const CameraCapture = lazy(
  () => import("./CameraCapture-9Eh5eP92.js").then((m) => ({ default: m.CameraCapture }))
);
...
function ScanPage() {
  ...
  const runScanPipeline = async (activeFile, activePreview, autoNavigate) => {
    ...
    try {
      ...
      const { scanFileAndStore } = await import("./scanPipeline-FjMkIsw1.js").then((n) => n.a);
  ...
  const visibleRecentContacts = recentContacts.filter((contact) => !removedRecentIds.has(String(contact.id))).slice(0, 8);
    ...
    /* @__PURE__ */ jsxs(Card, { className: "rounded-2xl border-border/60 p-5 shadow-soft", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "mt-0.5 text-xs text-muted-foreground", children: "Recently captured cards on this device." })
        ] }),
