...
import { h as cn, B as Button } from "./router-VRE0sT79.js";
  ...
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-[100] flex flex-col bg-black", role: "dialog", "aria-modal": "true", children: /* @__PURE__ */ jsx("div", { className: "relative flex-1 overflow-hidden", children: phase === "live" ? /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    error && !isStarting && /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 z-20 flex flex-col items-center justify-center gap-5 bg-black px-8 text-center text-white", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex w-full max-w-xs flex-col gap-2", children: [
        /* @__PURE__ */ jsx(Button, { className: "h-9 w-full rounded-md", onClick: restartCamera, children: "Try again" }),
        /* @__PURE__ */ jsx(Button, { variant: "outline", className: "h-9 w-full rounded-md border-white/20 bg-white/5 text-white hover:bg-white/10", onClick: handleClose, children: "Use folder upload instead" })
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "absolute inset-x-0 bottom-0 flex gap-3 bg-gradient-to-t from-black/90 to-transparent px-4 pb-8 pt-12", children: [
      /* @__PURE__ */ jsx(Button, { variant: "outline", className: "h-9 flex-1 rounded-md border-white/30 bg-white/10 text-white hover:bg-white/20", onClick: handleRetake, children: "Retake" }),
      /* @__PURE__ */ jsxs(Button, { className: "flex-1 h-9 rounded-md bg-gradient-primary shadow-glow", onClick: handleContinue, children: [
