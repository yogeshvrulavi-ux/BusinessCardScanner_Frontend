...
import { A as AuthGate, c as apiFetch, d as API_BASE_URL, B as Button } from "./router-VRE0sT79.js";
...
function AuditLogsPageInner() {
  ...
  return /* @__PURE__ */ jsx(
    PageShell,
    {
      ...
      actions: /* @__PURE__ */ jsxs(Button, { variant: "outline", onClick: () => void load(true), disabled: isRefreshing, className: "h-9 rounded-md", children: [
