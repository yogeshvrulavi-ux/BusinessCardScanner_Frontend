...
import { A as AuthGate, a as useConfirmModal, u as useAuth, I as Input, B as Button } from "./router-VRE0sT79.js";
import { B as Badge } from "./badge-CZj7XPhQ.js";
import { I as InviteUserModal } from "./InviteUserModal-Ckk2rydu.js";
import { toast } from "sonner";
import { e as fetchInvitations, r as resendInvitation, g as revokeInvitation } from "./adminApi-tL7U-5o6.js";
    ...
    /* @__PURE__ */ jsx(
      PageShell,
      {
        ...
        actions: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-2", children: [
          ...
          /* @__PURE__ */ jsxs(Button, { onClick: () => setInviteOpen(true), className: "h-9 rounded-md bg-gradient-primary", children: [
        ...
        children: /* @__PURE__ */ jsxs(Card, { className: "rounded-2xl border-border/60 p-4 shadow-soft sm:p-6", children: [
          ...
          isLoading ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-16", children: [
            ...
            /* @__PURE__ */ jsxs(Button, { className: "mt-5 h-9 rounded-md bg-gradient-primary", onClick: () => setInviteOpen(true), children: [
              /* @__PURE__ */ jsx(Plus, { className: "mr-2 h-4 w-4" }),
              "Send invitation"
            ] })
