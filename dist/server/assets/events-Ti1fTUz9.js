...
import { y as loadEvents, R as Route, p as useContactsDirectory, Q as purgeOrphanExampleEvent, P as PAGE, I as Input, t as getExampleEventName, B as Button, h as cn, S as rememberEvent, U as contactRowKey, i as invalidateContactsDirectory, A as AuthGate } from "./router-DJrz5rEK.js";
import { S as StatusPill } from "./StatusPill-DX2V4MQx.js";
import { C as CardThumbnail } from "./CardThumbnail-CDI6ANgW.js";
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "hidden overflow-x-auto rounded-xl border border-border/60 lg:block", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
      /* @__PURE__ */ jsx("thead", { className: "bg-gradient-primary text-left text-[11px] font-bold uppercase tracking-wider text-white", children: /* @__PURE__ */ jsxs("tr", { children: [
        /* @__PURE__ */ jsx("th", { className: "px-4 py-3 font-bold text-white", children: "Contact" }),
        ...
        /* @__PURE__ */ jsx("th", { className: "px-4 py-3 font-bold text-white", children: "Notes" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "mb-5 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
                ...
                /* @__PURE__ */ jsxs(Button, { type: "button", size: "sm", onClick: handleCreateEvent, className: "shrink-0 rounded-md", children: [
                  /* @__PURE__ */ jsx(Plus, { className: "mr-1.5 h-4 w-4" }),
                  "Create"
                ] })
              ] }),
              selectedEventName ? /* @__PURE__ */ jsxs(Button, { variant: "ghost", size: "sm", onClick: clearSelection, className: "rounded-md", children: [
