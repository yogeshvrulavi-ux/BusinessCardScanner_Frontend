...
import { A as AuthGate, a as useConfirmModal, B as Button } from "./router-CKY3IDgE.js";
import { I as InviteUserModal, B as Badge } from "./InviteUserModal-Brzk47RK.js";
import { toast } from "sonner";
import { e as fetchCompanies, g as deleteCompany } from "./adminApi-13-dsoaq.js";
...
function CompaniesPageInner() {
  ...
  const handleDelete = async (company) => {
    ...
    const ok = await confirm({
      ...
      description: `Are you sure you want to delete the company for "${label}"${company.company_name ? ` (${company.company_name})` : ""}? This action cannot be undone.`,
      confirmLabel: "Delete",
      destructive: true
    });
    if (!ok) return;
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(
      PageShell,
      {
        ...
        description: total > 0 ? `${total} admin${total === 1 ? "" : "s"}` : "Invite and manage company Admins",
        ...
        children: /* @__PURE__ */ jsx(Card, { className: "rounded-2xl border-border/60 p-4 shadow-soft sm:p-6", children: isLoading ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-16", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "mt-3 text-sm text-muted-foreground", children: "Loading admins…" })
          ...
          /* @__PURE__ */ jsx("h3", { className: "mt-4 font-display text-lg font-semibold", children: "No admins yet" }),
          ...
          /* @__PURE__ */ jsx("div", { className: "hidden overflow-x-auto rounded-xl border border-border/60 lg:block", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
            /* @__PURE__ */ jsx("thead", { className: "bg-gradient-primary text-left text-[11px] font-bold uppercase tracking-wider text-white", children: /* @__PURE__ */ jsxs("tr", { children: [
              /* @__PURE__ */ jsx("th", { className: "px-4 py-3 font-bold text-white", children: "Admin" }),
              /* @__PURE__ */ jsx("th", { className: "px-4 py-3 font-bold text-white", children: "Designation" }),
              /* @__PURE__ */ jsx("th", { className: "px-4 py-3 font-bold text-white", children: "Users" }),
              /* @__PURE__ */ jsx("th", { className: "px-4 py-3 font-bold text-white", children: "Code" }),
            ...
            /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-border/60", children: companies.map((c) => {
              ...
              return /* @__PURE__ */ jsxs("tr", { className: "transition hover:bg-muted/30", children: [
                /* @__PURE__ */ jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("div", { className: "font-medium", children: hasAdmin ? label : "No admin yet" }),
                    hasAdmin && c.admin_email && label !== c.admin_email ? /* @__PURE__ */ jsx("div", { className: "text-[11px] text-muted-foreground", children: c.admin_email }) : null
                  ] })
                ] }) }),
                /* @__PURE__ */ jsxs("td", { className: "px-4 py-3", children: [
                  /* @__PURE__ */ jsx("div", { className: "text-sm text-muted-foreground", children: c.admin_designation?.trim() || "Admin" }),
                  c.admin_department?.trim() ? /* @__PURE__ */ jsx("div", { className: "text-[11px] text-muted-foreground/80", children: c.admin_department.trim() }) : null
                ] }),
                /* @__PURE__ */ jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsx("span", { className: "inline-flex items-center rounded-md bg-muted px-2 py-0.5 text-xs font-medium tabular-nums", children: c.user_count ?? 0 }) }),
          ...
          /* @__PURE__ */ jsx("div", { className: "space-y-3 lg:hidden", children: companies.map((c) => {
            const label = adminLabel(c);
            const hasAdmin = Boolean(c.admin_name || c.admin_email);
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-2", children: [
                        /* @__PURE__ */ jsx("span", { className: "truncate font-medium", children: hasAdmin ? label : "No admin yet" }),
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "mt-0.5 text-xs text-muted-foreground", children: [
                        ...
                        c.admin_department?.trim() ? ` · ${c.admin_department.trim()}` : "",
                        " · ",
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "mt-1 text-[11px] text-muted-foreground", children: [
                        hasAdmin && c.admin_email && label !== c.admin_email ? `${c.admin_email} · ` : "",
                        c.user_count ?? 0,
                        " user",
                        (c.user_count ?? 0) === 1 ? "" : "s",
                        " · ",
