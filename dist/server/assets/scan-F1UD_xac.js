...
import { e as cn, p as getConnectionMode, q as useUserSettings, r as getLastUsedEventName, C as CONNECTION_MODE_CHANGED, P as PAGE, B as Button, t as getCachedContacts, g as getQueueItems, l as listContacts, v as cacheContacts, j as loadUserSettings } from "./router-CgoztCPx.js";
...
const CameraCapture = lazy(
  () => import("./CameraCapture-DcKoXSKs.js").then((m) => ({ default: m.CameraCapture }))
);
function ScanPage() {
  ...
  const runScanPipeline = async (activeFile, activePreview, autoNavigate) => {
    ...
    try {
      ...
      const { scanFileAndStore } = await import("./scanPipeline-LsgFENuC.js").then((n) => n.a);
      await scanFileAndStore(activeFile, activePreview, ({ progress: progress2, message }) => {
  ...
  return /* @__PURE__ */ jsxs(PageShell, { title: PAGE.capture.title, description: PAGE.capture.description, children: [
    /* @__PURE__ */ jsx("div", { className: "relative overflow-hidden rounded-2xl border border-border/60 bg-card/40 p-5 backdrop-blur-xl shadow-soft", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row md:items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
        ...
        activeEventName ? /* @__PURE__ */ jsx("div", { className: "pt-1", children: /* @__PURE__ */ jsxs(Badge, { variant: "secondary", className: "rounded-lg px-2.5 py-1 text-[11px] font-medium", children: [
          "Active event: ",
          activeEventName
        ] }) }) : null
      ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid gap-6 lg:grid-cols-5", children: [
      ...
      /* @__PURE__ */ jsxs(Card, { className: "relative overflow-hidden rounded-2xl border-border/60 p-6 shadow-soft lg:col-span-2 flex flex-col", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-auto pt-4", children: /* @__PURE__ */ jsx(Button, { asChild: true, className: "w-full rounded-xl bg-gradient-primary shadow-glow", disabled: !isComplete, children: /* @__PURE__ */ jsxs(Link, { to: "/review", children: [
          /* @__PURE__ */ jsx(ScanLine, { className: "mr-2 h-4 w-4" }),
