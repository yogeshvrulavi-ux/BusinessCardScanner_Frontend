...
async function clearLocalQueueOnly() {
  const appUser = await getCurrentAppUser();
  const { clearUserSyncQueue } = await import("./router-ZM5rT6gC.js").then((n) => n.a9);
            ...
            SettingRow,
            {
              ...
              onCheckedChange: (v) => {
                ...
                if (v && typeof navigator !== "undefined" && navigator.onLine) {
                  void import("./router-ZM5rT6gC.js").then((n) => n.aa).then(
