...
import { P as PageShell, C as Card } from "./PageShell-wENTkti4.js";
import { b as getCurrentAppUser, N as removeQueueItem, X as removeOutreachStatusForContact, Y as deleteContactFromBackend, g as getQueueItems, Z as contactBelongsToAppUser, _ as getStoredContactById, $ as optimisticallyRemoveDirectoryContact, i as invalidateContactsDirectory, a0 as resolveChannelIconStatus, h as cn, a as useConfirmModal, a1 as Route, u as useAuth, S as useContactsDirectory, q as useUserSettings, E as loadEvents, W as contactRowKey, P as PAGE, I as Input, B as Button, Q as syncQueueItem, M as syncAllQueueItems } from "./router-gDbAJgHl.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-B_s0fL8G.js";
import { S as StatusPill } from "./StatusPill-5kmKbNmZ.js";
import { T as Tabs, a as TabsList, b as TabsTrigger } from "./tabs-D_IL5k6x.js";
    ...
    PageShell,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs(Card, { className: "rounded-2xl border-border/60 p-3 shadow-soft sm:p-5", children: [
          showFilters && /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3", children: [
