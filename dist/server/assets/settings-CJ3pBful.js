...
async function clearLocalQueueOnly() {
  const appUser = await getCurrentAppUser();
  const { clearUserSyncQueue } = await import("./router-CElpkivw.js").then((n) => n.ac);
            ...
            SettingRow,
            {
              ...
              onCheckedChange: (v) => {
                ...
                if (v && typeof navigator !== "undefined" && navigator.onLine) {
                  void import("./router-CElpkivw.js").then((n) => n.ad).then(
