...
import { h as cn, u as useAuth, I as Input, B as Button } from "./router-CKY3IDgE.js";
...
import { e as fetchCompanies, s as sendInvitation } from "./adminApi-13-dsoaq.js";
...
function InviteUserModal({ open, onOpenChange, onSuccess, role }) {
  const { user: authUser } = useAuth();
  const isSuperAdmin = authUser?.role === "SUPER_ADMIN";
  const inviteRole = role ?? (isSuperAdmin ? "ADMIN" : "USER");
  ...
  useEffect(() => {
    ...
    void fetchCompanies(1, 200).then((res) => {
      ...
      children: /* @__PURE__ */ jsxs(DialogContent, { className: "max-w-md rounded-2xl", children: [
        ...
        /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs(Label, { htmlFor: "invite_email", children: [
              roleLabel,
              " email *"
            ] }),
            /* @__PURE__ */ jsx(
          ...
          needsCompanyPicker ? /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "invite_company", children: "Company *" }),
            /* @__PURE__ */ jsxs(
              Select,
              {
                value: companyId,
                ...
                children: [
                  /* @__PURE__ */ jsx(SelectTrigger, { id: "invite_company", className: "mt-1.5 h-10", children: /* @__PURE__ */ jsx(
                    SelectValue,
                    {
                      placeholder: isLoadingCompanies ? "Loading companies…" : "Select company"
                    }
                  ) }),
                  /* @__PURE__ */ jsx(SelectContent, { children: companies.map((c) => /* @__PURE__ */ jsxs(SelectItem, { value: c.id, children: [
                    c.company_name,
                    c.admin_name || c.admin_email ? ` · ${c.admin_name || c.admin_email}` : ""
                  ] }, c.id)) })
                ]
              }
            ),
            /* @__PURE__ */ jsx("p", { className: "mt-1.5 text-xs text-muted-foreground", children: "The invited user will belong to this company under its Admin." })
          ] }) : null,
