...
import { Sparkles, X, CheckCircle2, Loader2, ScanLine, Upload, FileImage, Camera, Trash2 } from "lucide-react";
import { P as PageShell, C as Card } from "./PageShell-BozHmfmh.js";
import { p as useContactsDirectory, q as useUserSettings, P as PAGE, B as Button, j as loadUserSettings } from "./router-CKY3IDgE.js";
...
const CameraCapture = lazy(
  () => import("./CameraCapture-Bi6Z0HKF.js").then((m) => ({ default: m.CameraCapture }))
);
const REMOVED_RECENT_SCANS_KEY = "cs-removed-recent-scans";
const RECENT_SCANS_LIMIT = 5;
function contactRecencyMs(createdAt) {
...
function ScanPage() {
  ...
  const [removedRecentIds, setRemovedRecentIds] = useState(() => {
  ...
  const runScanPipeline = async (activeFile, activePreview, autoNavigate) => {
    ...
    try {
      ...
      const { scanFileAndStore } = await import("./scanPipeline-pVjeKjgw.js").then((n) => n.d);
  ...
  const removeRecentScan = (contactId) => {
  ...
  const visibleRecentContacts = useMemo(() => {
    return [...directoryContacts].filter((contact) => !removedRecentIds.has(String(contact.id))).sort((a, b) => contactRecencyMs(b.createdAt) - contactRecencyMs(a.createdAt)).slice(0, RECENT_SCANS_LIMIT);
  ...
  return /* @__PURE__ */ jsxs(PageShell, { title: PAGE.capture.title, description: PAGE.capture.description, children: [
    /* @__PURE__ */ jsx("div", { className: "relative overflow-hidden rounded-2xl border border-border/60 bg-card/40 p-5 backdrop-blur-xl shadow-soft", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row md:items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
        /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxs("h2", { className: "text-xl font-semibold tracking-tight text-foreground sm:text-2xl", children: [
          greetingText,
          ", ",
          /* @__PURE__ */ jsx("span", { className: "bg-gradient-to-r from-primary to-teal-500 bg-clip-text text-transparent", children: firstName })
        ] }) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid gap-6 lg:grid-cols-5", children: [
          ...
          "div",
          {
            ...
            children: preview ? /* @__PURE__ */ jsxs("div", { className: "w-full h-full flex flex-col items-center justify-center fade-in", children: [
              /* @__PURE__ */ jsxs("div", { className: "relative w-full max-w-[240px] rounded-xl overflow-hidden shadow-soft mb-4 border border-border/60", children: [
                ...
                !isProcessing && !isComplete && /* @__PURE__ */ jsx("div", { className: "absolute top-2 right-2", children: /* @__PURE__ */ jsx(Button, { variant: "secondary", size: "icon", className: "h-7 w-7 rounded-md bg-background/80 hover:bg-background backdrop-blur shadow-soft text-foreground", onClick: clearFile, children: /* @__PURE__ */ jsx(X, { className: "h-4 w-4" }) }) })
              ] }),
              ...
              isComplete ? /* @__PURE__ */ jsxs("div", { className: "w-full max-w-xs mt-6 space-y-3 text-center fade-in", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 mt-4", children: [
                  /* @__PURE__ */ jsx(Button, { asChild: true, className: "w-full rounded-md bg-gradient-primary shadow-glow", children: /* @__PURE__ */ jsx(Link, { to: "/review", children: "Review & Save Contact" }) }),
                  /* @__PURE__ */ jsx(Button, { variant: "outline", className: "w-full rounded-md", onClick: clearFile, children: "Scan another card" })
                ] })
              ...
              ] }) : /* @__PURE__ */ jsx("div", { className: "mt-6 flex flex-wrap justify-center gap-2 w-full fade-in", children: /* @__PURE__ */ jsxs(Button, { onClick: () => handleProcess(), className: "w-full sm:w-auto rounded-md bg-gradient-primary shadow-glow", children: [
                /* @__PURE__ */ jsx(ScanLine, { className: "mr-2 h-4 w-4" }),
                " Process card"
              ] }) })
            ] }) : /* @__PURE__ */ jsxs("div", { className: "fade-in flex flex-col items-center", children: [
              /* @__PURE__ */ jsx("div", { className: "pointer-events-none mx-auto flex h-14 w-14 items-center justify-center rounded-md bg-gradient-primary text-primary-foreground shadow-glow", children: /* @__PURE__ */ jsx(Upload, { className: "h-6 w-6" }) }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "mt-6 flex flex-col sm:flex-row flex-wrap items-center justify-center gap-2 w-full", children: [
                /* @__PURE__ */ jsxs(Button, { onClick: () => fileInputRef.current?.click(), className: "w-full sm:w-auto rounded-md bg-gradient-primary shadow-glow", children: [
                  /* @__PURE__ */ jsx(FileImage, { className: "mr-2 h-4 w-4" }),
                  " Choose from folder"
                ] }),
                /* @__PURE__ */ jsxs(Button, { variant: "outline", onClick: () => setCameraOpen(true), className: "w-full sm:w-auto rounded-md", children: [
      ...
      /* @__PURE__ */ jsxs(Card, { className: "relative overflow-hidden rounded-2xl border-border/60 p-6 shadow-soft lg:col-span-2 flex flex-col", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-auto pt-4", children: isComplete ? /* @__PURE__ */ jsx(Button, { asChild: true, className: "w-full rounded-md bg-gradient-primary shadow-glow", children: /* @__PURE__ */ jsxs(Link, { to: "/review", children: [
          /* @__PURE__ */ jsx(ScanLine, { className: "mr-2 h-4 w-4" }),
          " Review extracted details"
        ] }) }) : /* @__PURE__ */ jsxs(Button, { disabled: true, className: "w-full rounded-md bg-gradient-primary shadow-glow", children: [
          /* @__PURE__ */ jsx(ScanLine, { className: "mr-2 h-4 w-4" }),
          " Review extracted details"
        ] }) })
      ] })
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxs("p", { className: "mt-0.5 text-xs text-muted-foreground", children: [
            "Latest ",
            RECENT_SCANS_LIMIT,
            " contacts from your directory."
          ] })
        ] }),
        /* @__PURE__ */ jsx(Button, { asChild: true, variant: "ghost", size: "sm", className: "rounded-md text-xs", children: /* @__PURE__ */ jsx(Link, { to: "/contacts", children: "View all" }) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "mt-4 flex gap-3 overflow-x-auto pb-4 snap-x snap-mandatory hide-scrollbar", children: [
        visibleRecentContacts.map((c) => /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "mt-2 flex items-center justify-between gap-2", children: [
                /* @__PURE__ */ jsx("div", { className: "truncate text-[11px] text-muted-foreground", children: c.lastSync }),
                /* @__PURE__ */ jsxs(
                  Button,
                  {
                    type: "button",
        ...
        visibleRecentContacts.length === 0 && /* @__PURE__ */ jsx("div", { className: "text-xs text-muted-foreground italic py-4 pl-1", children: "No recent scans found." })
      ] })
    ] }),
