import { a2 as listStoredContacts } from "./router-VRE0sT79.js";
...
async function checkForDuplicates(payload) {
  if (typeof navigator === "undefined" || navigator.onLine) {
    try {
      const { API_BASE_URL } = await import("./router-VRE0sT79.js").then((n) => n.a4);
      const { apiFetch } = await import("./router-VRE0sT79.js").then((n) => n.a3);
  ...
  try {
    const { getQueueItems } = await import("./router-VRE0sT79.js").then((n) => n.a5);
