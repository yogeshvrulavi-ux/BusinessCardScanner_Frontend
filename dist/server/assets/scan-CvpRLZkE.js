...
import { p as useContactsDirectory, q as useUserSettings, P as PAGE, B as Button, j as loadUserSettings } from "./router-DJrz5rEK.js";
...
const CameraCapture = lazy(
  () => import("./CameraCapture-uqLcN9mx.js").then((m) => ({ default: m.CameraCapture }))
);
...
function ScanPage() {
  ...
  const runScanPipeline = async (activeFile, activePreview, autoNavigate) => {
    ...
    try {
      ...
      const { scanFileAndStore } = await import("./scanPipeline-COG8c5EM.js").then((n) => n.d);
