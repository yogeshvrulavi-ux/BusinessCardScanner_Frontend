...
import { T as Tabs, a as TabsList, b as TabsTrigger } from "./tabs-BXNrskuH.js";
...
import { u as useCardImage } from "./CardThumbnail-D3bZa1cH.js";
  ...
  return /* @__PURE__ */ jsx("div", { className: "page-bottom-safe lg:pb-0", children: /* @__PURE__ */ jsxs(
    PageShell,
    {
      ...
      actions: /* @__PURE__ */ jsxs("div", { className: "grid w-full grid-cols-2 gap-2 sm:flex sm:w-auto sm:flex-wrap sm:justify-end", children: [
        /* @__PURE__ */ jsxs(Button, { variant: "outline", onClick: () => void reloadContacts({ force: true }), disabled: isRefreshing, className: "h-9 w-full rounded-md sm:w-auto", children: [
