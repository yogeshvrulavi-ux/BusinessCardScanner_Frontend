...
import { u as useAuth, I as Input, B as Button, A as AuthGate, a as useConfirmModal } from "./router-Bh1EUmi_.js";
import { B as Badge } from "./badge-Df_zPO9H.js";
import { I as InviteUserModal } from "./InviteUserModal-C5h31Ama.js";
...
import { u as updateUser, a as adminResetPassword, f as fetchUsers, b as updateUserStatus, d as deleteUser } from "./adminApi-dUj9P00y.js";
      ...
      PageShell,
      {
        ...
        children: /* @__PURE__ */ jsxs(Card, { className: "rounded-2xl border-border/60 p-4 shadow-soft sm:p-6", children: [
          ...
          isLoading ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-16", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "mt-1 max-w-xs text-sm text-muted-foreground", children: "Invite someone by email. They create their own password." }),
            /* @__PURE__ */ jsxs(
              Button,
              {
