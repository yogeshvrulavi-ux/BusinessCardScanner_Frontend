...
import { A as AuthGate, a as useConfirmModal, B as Button } from "./router-DJrz5rEK.js";
import { I as InviteUserModal, B as Badge } from "./InviteUserModal-CUE9WWoe.js";
import { toast } from "sonner";
import { e as fetchCompanies, g as deleteCompany } from "./adminApi-Bky3dCXr.js";
...
import "zod";
import "./select-Cyqtf15t.js";
import "@radix-ui/react-select";
import "./label-CYxZdC0e.js";
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(
      PageShell,
      {
        ...
        description: total > 0 ? `${total} employee${total === 1 ? "" : "s"}` : "Invite and manage company Admins",
        ...
        children: /* @__PURE__ */ jsx(Card, { className: "rounded-2xl border-border/60 p-4 shadow-soft sm:p-6", children: isLoading ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-16", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "mt-3 text-sm text-muted-foreground", children: "Loading employees…" })
          ...
          /* @__PURE__ */ jsx("h3", { className: "mt-4 font-display text-lg font-semibold", children: "No employees yet" }),
          ...
          /* @__PURE__ */ jsx("div", { className: "hidden overflow-x-auto rounded-xl border border-border/60 lg:block", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
            /* @__PURE__ */ jsx("thead", { className: "bg-gradient-primary text-left text-[11px] font-bold uppercase tracking-wider text-white", children: /* @__PURE__ */ jsxs("tr", { children: [
              /* @__PURE__ */ jsx("th", { className: "px-4 py-3 font-bold text-white", children: "Name" }),
              /* @__PURE__ */ jsx("th", { className: "px-4 py-3 font-bold text-white", children: "Email" }),
              /* @__PURE__ */ jsx("th", { className: "px-4 py-3 font-bold text-white", children: "Department / Designation" }),
                ...
                /* @__PURE__ */ jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "text-[11px] text-muted-foreground", children: [
                      ...
                      (c.user_count ?? 0) === 1 ? "" : "s",
                      " · ",
                      /* @__PURE__ */ jsx("code", { className: "rounded bg-muted px-1 py-0.5 font-mono", children: c.company_code })
                    ] })
                  ] })
                ] }) }),
                /* @__PURE__ */ jsx("td", { className: "px-4 py-3 text-sm text-muted-foreground", children: c.admin_email?.trim() || "—" }),
                /* @__PURE__ */ jsxs("td", { className: "px-4 py-3", children: [
                  /* @__PURE__ */ jsx("div", { className: "text-sm text-muted-foreground", children: designation }),
                  department ? /* @__PURE__ */ jsx("div", { className: "text-[11px] text-muted-foreground/80", children: department }) : null
                ] }),
                ...
                children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
                      ...
                      /* @__PURE__ */ jsx("div", { className: "mt-0.5 text-xs text-muted-foreground", children: c.admin_email?.trim() || "—" }),
