...
import { Loader2, Save, KeyRound, Search, User, Plus, UserCheck, UserX, Pencil, Trash2, RefreshCw } from "lucide-react";
import { P as PageShell, C as Card } from "./PageShell-CAiM-dst.js";
import { u as useAuth, I as Input, B as Button, A as AuthGate, a as useConfirmModal } from "./router-DJrz5rEK.js";
import { I as InviteUserModal, B as Badge } from "./InviteUserModal-CUE9WWoe.js";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogDescription, S as Select, e as SelectTrigger, f as SelectValue, g as SelectContent, h as SelectItem, i as DialogFooter } from "./select-Cyqtf15t.js";
import { L as Label } from "./label-CYxZdC0e.js";
import { S as Switch } from "./switch-CA3Yb-s2.js";
import { toast } from "sonner";
import { u as updateUser, a as adminResetPassword, f as fetchUsers, b as updateUserStatus, d as deleteUser } from "./adminApi-Bky3dCXr.js";
import { p as personInitials, f as formatPersonDisplay } from "./personDisplay-Cb1M3koG.js";
import { T as TABLE_PAGE_SIZE, c as clampPageAfterDelete, a as TablePagination } from "./table-pagination-R8ymbfwN.js";
...
function adminOfUserLabel(user) {
  return formatPersonDisplay({
...
function UsersPageInner() {
  ...
  const load = useCallback(async (silent = false, pageOverride) => {
  ...
  const filtered = useMemo(() => {
    ...
    return users.filter(
      (u) => `${u.first_name} ${u.last_name}`.toLowerCase().includes(q) || u.email.toLowerCase().includes(q) || u.username.toLowerCase().includes(q) || u.role.toLowerCase().includes(q) || (u.company_name || "").toLowerCase().includes(q) || (u.admin_name || "").toLowerCase().includes(q) || (u.admin_email || "").toLowerCase().includes(q)
    );
  }, [users, search]);
  ...
  const handleToggleActive = async (user) => {
    ...
    const ok = await confirm({
      ...
      description: next ? `"${label}" will be able to log in again.` : `"${label}" will be signed out and cannot log in.`,
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(
      PageShell,
      {
        ...
        description: adminSummary ? `${adminSummary.adminCount} admin${adminSummary.adminCount === 1 ? "" : "s"} · ${adminSummary.userTotal} user${adminSummary.userTotal === 1 ? "" : "s"}` : total > 0 ? `${total} user${total === 1 ? "" : "s"} total` : "Invite and manage users",
        ...
        children: /* @__PURE__ */ jsxs(Card, { className: "rounded-2xl border-border/60 p-4 shadow-soft sm:p-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "relative mb-4", children: [
            ...
            /* @__PURE__ */ jsx(
              Input,
              {
                ...
                placeholder: isSuperAdmin ? "Search by name, email, company, or admin" : "Search by name, email, username, or role",
          ...
          isLoading ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-16", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "mt-1 max-w-xs text-sm text-muted-foreground", children: "Invite a user by email. They appear here after they accept and register." }),
            /* @__PURE__ */ jsxs(
              Button,
              {
            ...
            /* @__PURE__ */ jsx("div", { className: "hidden overflow-x-auto rounded-xl border border-border/60 lg:block", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
              /* @__PURE__ */ jsx("thead", { className: "bg-gradient-primary text-left text-[11px] font-bold uppercase tracking-wider text-white", children: /* @__PURE__ */ jsxs("tr", { children: [
                /* @__PURE__ */ jsx("th", { className: "px-4 py-3 font-bold text-white", children: "User" }),
                ...
                isSuperAdmin ? /* @__PURE__ */ jsxs(Fragment, { children: [
                  ...
                  /* @__PURE__ */ jsx("th", { className: "px-4 py-3 font-bold text-white", children: "Admin / Users" })
                ] }) : null,
                /* @__PURE__ */ jsx("th", { className: "px-4 py-3 font-bold text-white", children: "Status" }),
                /* @__PURE__ */ jsx("th", { className: "px-4 py-3 font-bold text-white", children: "Last Login" }),
                /* @__PURE__ */ jsx("th", { className: "px-4 py-3 font-bold text-white text-right", children: "Actions" })
              ] }) }),
              /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-border/60", children: filtered.map((u) => {
                const label = userDisplayName(u);
                const adminLabel = adminOfUserLabel(u);
                return /* @__PURE__ */ jsxs("tr", { className: "transition hover:bg-muted/30", children: [
                  /* @__PURE__ */ jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                    /* @__PURE__ */ jsx("div", { className: "flex h-9 w-9 items-center justify-center rounded-xl bg-primary/10 text-xs font-semibold text-primary", children: personInitials({
                    ...
                    /* @__PURE__ */ jsxs("div", { children: [
                      ...
                      label !== u.email ? /* @__PURE__ */ jsx("div", { className: "text-[11px] text-muted-foreground", children: u.email }) : null
                    ] })
                  ] }) }),
                  ...
                  isSuperAdmin ? /* @__PURE__ */ jsxs(Fragment, { children: [
                    /* @__PURE__ */ jsx("td", { className: "px-4 py-3 text-xs text-muted-foreground", children: u.company_name || "—" }),
                    /* @__PURE__ */ jsx("td", { className: "px-4 py-3 text-xs", children: u.role === "ADMIN" ? /* @__PURE__ */ jsxs("div", { children: [
                    ...
                    ] }) : adminLabel ? /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("div", { className: "font-medium text-foreground", children: adminLabel }),
                      u.admin_email && adminLabel !== u.admin_email ? /* @__PURE__ */ jsx("div", { className: "text-[11px] text-muted-foreground", children: u.admin_email }) : null
                    ] }) : /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: "—" }) })
                  ] }) : null,
                  /* @__PURE__ */ jsx("td", { className: "px-4 py-3", children: u.is_active ? /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 text-xs text-emerald-600 dark:text-emerald-400", children: [
                  ...
                  /* @__PURE__ */ jsx("td", { className: "px-4 py-3 text-right", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-1", children: [
                    ...
                    /* @__PURE__ */ jsx(
                      Button,
                      {
                        ...
                        className: `h-8 w-8 rounded-md cursor-pointer ${u.is_active ? "text-muted-foreground hover:text-amber-600 hover:bg-amber-50 dark:hover:bg-amber-950/40" : "text-muted-foreground hover:text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-950/40"}`,
            ...
            /* @__PURE__ */ jsx("div", { className: "space-y-3 lg:hidden", children: filtered.map((u) => {
              const label = userDisplayName(u);
              const adminLabel = adminOfUserLabel(u);
                ...
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
                      /* @__PURE__ */ jsx("div", { className: "flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-primary/10 text-sm font-semibold text-primary", children: personInitials({
                        firstName: u.first_name,
                        lastName: u.last_name,
                        email: u.email
                      }) }),
                      /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
                        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-2", children: [
                          /* @__PURE__ */ jsx("span", { className: "truncate font-medium", children: label }),
                        ...
                        label !== u.email ? /* @__PURE__ */ jsx("div", { className: "mt-0.5 truncate text-xs text-muted-foreground", children: u.email }) : null,
                        isSuperAdmin ? /* @__PURE__ */ jsxs("div", { className: "mt-1 text-[11px] text-muted-foreground", children: [
                          u.company_name || "No company",
                          u.role === "ADMIN" ? ` · ${u.user_count ?? 0} user${(u.user_count ?? 0) === 1 ? "" : "s"}` : adminLabel ? ` · Admin: ${adminLabel}` : ""
                        ] }) : null,
                        /* @__PURE__ */ jsxs("div", { className: "mt-1 flex items-center gap-2", children: [
                          u.is_active ? /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 text-[11px] text-emerald-600 dark:text-emerald-400", children: [
