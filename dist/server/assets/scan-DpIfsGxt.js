...
import { p as useContactsDirectory, q as useUserSettings, P as PAGE, B as Button, j as loadUserSettings } from "./router-VRE0sT79.js";
...
const CameraCapture = lazy(
  () => import("./CameraCapture-BC3XFahD.js").then((m) => ({ default: m.CameraCapture }))
);
...
function ScanPage() {
  ...
  const runScanPipeline = async (activeFile, activePreview, autoNavigate) => {
    ...
    try {
      ...
      const { scanFileAndStore } = await import("./scanPipeline-DxplHOeb.js").then((n) => n.a);
  ...
  return /* @__PURE__ */ jsxs(PageShell, { title: PAGE.capture.title, description: PAGE.capture.description, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid gap-6 lg:grid-cols-5", children: [
            ...
            children: preview ? /* @__PURE__ */ jsxs("div", { className: "w-full h-full flex flex-col items-center justify-center fade-in", children: [
              ...
              isComplete ? /* @__PURE__ */ jsxs("div", { className: "w-full max-w-xs mt-6 space-y-3 text-center fade-in", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 mt-4", children: [
                  /* @__PURE__ */ jsx(Button, { asChild: true, className: "w-full h-9 rounded-md bg-gradient-primary shadow-glow", children: /* @__PURE__ */ jsx(Link, { to: "/review", children: "Review & Save Contact" }) }),
                  /* @__PURE__ */ jsx(Button, { variant: "outline", className: "h-9 w-full rounded-md", onClick: clearFile, children: "Scan another card" })
                ] })
              ...
              ] }) : /* @__PURE__ */ jsx("div", { className: "mt-6 flex flex-wrap justify-center gap-2 w-full fade-in", children: /* @__PURE__ */ jsxs(Button, { onClick: () => handleProcess(), className: "w-full sm:w-auto h-9 rounded-md bg-gradient-primary shadow-glow", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "mt-6 flex flex-col sm:flex-row flex-wrap items-center justify-center gap-2 w-full", children: [
                /* @__PURE__ */ jsxs(Button, { onClick: () => fileInputRef.current?.click(), className: "w-full sm:w-auto h-9 rounded-md bg-gradient-primary shadow-glow", children: [
                  /* @__PURE__ */ jsx(FileImage, { className: "mr-2 h-4 w-4" }),
                  " Choose from folder"
                ] }),
                /* @__PURE__ */ jsxs(Button, { variant: "outline", onClick: () => setCameraOpen(true), className: "h-9 w-full sm:w-auto rounded-md", children: [
      ...
      /* @__PURE__ */ jsxs(Card, { className: "relative overflow-hidden rounded-2xl border-border/60 p-6 shadow-soft lg:col-span-2 flex flex-col", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-auto pt-4", children: isComplete ? /* @__PURE__ */ jsx(Button, { asChild: true, className: "w-full h-9 rounded-md bg-gradient-primary shadow-glow", children: /* @__PURE__ */ jsxs(Link, { to: "/review", children: [
          /* @__PURE__ */ jsx(ScanLine, { className: "mr-2 h-4 w-4" }),
          " Review extracted details"
        ] }) }) : /* @__PURE__ */ jsxs(Button, { disabled: true, className: "w-full h-9 rounded-md bg-gradient-primary shadow-glow", children: [
          /* @__PURE__ */ jsx(ScanLine, { className: "mr-2 h-4 w-4" }),
          " Review extracted details"
        ] }) })
      ] })
