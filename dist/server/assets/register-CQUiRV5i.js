...
import { G as useForceLightMode, H as AppLogo, B as Button, h as cn, j as loadUserSettings, s as saveUserSettings } from "./router-DJrz5rEK.js";
import { N as NeuralVortexBackground, A as AuthScannerPanel, a as AuthField } from "./interactive-neural-vortex-background-Spbnkd4g.js";
import { a as LEGAL_CONTACT_EMAIL, b as LEGAL_CONTACT_PHONE, L as LEGAL_PAGE_URLS } from "./legalContent-BC1YLxXm.js";
import { v as validateInvitationToken, c as acceptInvitation } from "./adminApi-Bky3dCXr.js";
    ...
    /* @__PURE__ */ jsxs("section", { className: "relative flex h-svh w-full min-w-0 flex-1 flex-col overflow-x-hidden bg-[#f4f7fb] lg:w-[58%]", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "relative z-10 flex flex-1 overflow-y-auto px-5 py-4 sm:px-10 lg:px-14", children: /* @__PURE__ */ jsx("div", { className: "m-auto w-full min-w-0 max-w-lg sm:max-w-xl", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto w-full rounded-2xl bg-white px-6 py-6 shadow-sm sm:px-8 sm:py-7", children: [
        ...
        !loading && error && /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsx(Button, { asChild: true, variant: "outline", className: "w-full rounded-md", children: /* @__PURE__ */ jsx(Link, { to: "/auth/$pathname", params: { pathname: "sign-in" }, children: "Go to sign in" }) })
        ] }),
        !loading && info && /* @__PURE__ */ jsxs("form", { className: "space-y-5", onSubmit: handleSubmit, noValidate: true, children: [
          /* @__PURE__ */ jsxs("section", { className: "space-y-3.5", children: [
            ...
            info.role === "ADMIN" ? /* @__PURE__ */ jsxs("div", { className: "grid gap-3.5 sm:grid-cols-2", children: [
              /* @__PURE__ */ jsx(
                AuthField,
                {
                  label: "Designation",
