import { a5 as listStoredContacts } from "./router-Dkk-a0yt.js";
...
async function checkForDuplicates(payload) {
  if (typeof navigator === "undefined" || navigator.onLine) {
    try {
      const { API_BASE_URL } = await import("./router-Dkk-a0yt.js").then((n) => n.a7);
      const { apiFetch } = await import("./router-Dkk-a0yt.js").then((n) => n.a6);
  ...
  try {
    const { getQueueItems } = await import("./router-Dkk-a0yt.js").then((n) => n.a8);
