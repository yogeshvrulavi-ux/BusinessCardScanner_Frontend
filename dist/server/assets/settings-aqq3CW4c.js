...
async function clearLocalQueueOnly() {
  const appUser = await getCurrentAppUser();
  const { clearUserSyncQueue } = await import("./router-CKY3IDgE.js").then((n) => n.a9);
            ...
            SettingRow,
            {
              ...
              onCheckedChange: (v) => {
                ...
                if (v && typeof navigator !== "undefined" && navigator.onLine) {
                  void import("./router-CKY3IDgE.js").then((n) => n.aa).then(
