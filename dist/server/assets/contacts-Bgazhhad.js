...
import { P as PageShell, C as Card } from "./PageShell-DyTFPaiE.js";
import { a as getCurrentAppUser, O as removeQueueItem, Y as removeOutreachStatusForContact, Z as deleteZohoLead, _ as getStoredContactById, $ as deleteStoredContact, g as getQueueItems, a0 as contactBelongsToAppUser, a1 as optimisticallyRemoveDirectoryContact, i as invalidateContactsDirectory, a2 as resolveChannelIconStatus, e as cn, u as useConfirmModal, a3 as Route, U as useContactsDirectory, q as useUserSettings, F as loadEvents, X as contactRowKey, P as PAGE, I as Input, B as Button, H as storageLabel, R as syncQueueItemToZoho, L as syncContactToZohoStorage, a4 as syncAllPendingToZohoStorage, N as syncAllQueueItemsToZoho, p as getConnectionMode } from "./router-CElpkivw.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-1KAt27kK.js";
import { S as StatusPill } from "./StatusPill-DzTAc3E2.js";
import { T as Tabs, a as TabsList, b as TabsTrigger } from "./tabs-CEcIclnw.js";
...
function isLocalStorageSource(source) {
...
function ContactsPage() {
  ...
  const isAppOnline = () => getConnectionMode() === "online" && typeof navigator !== "undefined" && navigator.onLine;
  ...
  const handleSyncQueueItem = async (queueId) => {
    ...
    try {
      const items = await getQueueItems();
      const item = items.find((q2) => q2.id === queueId);
      if (!item) {
  ...
  const handleSyncToZoho = async (contactId, source) => {
  ...
  const handleDelete = async (contact) => {
    const ok = await confirm({
      ...
      description: contact.source === "zoho" ? "Hide this lead from your list? The record stays in Zoho (soft delete) for audit and recovery." : "Remove this contact from your device?",
      confirmLabel: "Delete",
      destructive: true
    });
    if (!ok) return;
      ...
      actions: /* @__PURE__ */ jsxs("div", { className: "grid w-full grid-cols-2 gap-2 sm:flex sm:w-auto sm:flex-wrap sm:justify-end", children: [
        ...
        showSavePending && /* @__PURE__ */ jsxs(
          Button,
          {
            ...
            className: "h-10 w-full rounded-xl sm:w-auto",
            children: [
              isSyncingZoho ? /* @__PURE__ */ jsx(Loader2, { className: "mr-2 h-4 w-4 shrink-0 animate-spin" }) : /* @__PURE__ */ jsx(Send, { className: "mr-2 h-4 w-4 shrink-0" }),
              /* @__PURE__ */ jsx("span", { className: "sm:hidden", children: "Save" }),
              /* @__PURE__ */ jsx("span", { className: "hidden sm:inline", children: "Save on device" })
            ]
          }
        ),
      ...
      children: [
        /* @__PURE__ */ jsxs(Card, { className: "rounded-2xl border-border/60 p-3 shadow-soft sm:p-5", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-2 sm:flex-row sm:items-center", children: /* @__PURE__ */ jsxs(
              Select,
              {
            ...
            /* @__PURE__ */ jsx("div", { className: "w-full lg:hidden", children: /* @__PURE__ */ jsx(Tabs, { value: tab, onValueChange: (v) => setTab(v), className: "w-full", children: /* @__PURE__ */ jsx(TabsList, { className: "grid h-auto w-full grid-cols-4 gap-1 rounded-xl bg-muted/60 p-1", children: tabs.map((t) => /* @__PURE__ */ jsxs(
              TabsTrigger,
              {
                value: t.key,
            ...
            /* @__PURE__ */ jsx("div", { className: "hidden w-full overflow-x-auto hide-scrollbar pb-1 lg:block", children: /* @__PURE__ */ jsx(Tabs, { value: tab, onValueChange: (v) => setTab(v), className: "w-full min-w-max", children: /* @__PURE__ */ jsx(TabsList, { className: "rounded-xl bg-muted/60", children: tabs.map((t) => /* @__PURE__ */ jsxs(TabsTrigger, { value: t.key, className: "rounded-lg text-xs data-[state=active]:bg-card data-[state=active]:shadow-soft", children: [
              t.label,
              " ",
          ...
          showInitialLoading ? /* @__PURE__ */ jsxs("div", { className: "mt-8 flex flex-col items-center justify-center py-12 text-center", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "flex h-16 w-16 items-center justify-center rounded-2xl bg-destructive/10", children: /* @__PURE__ */ jsx("span", { className: "text-xl text-destructive", children: "⚠️" }) }),
            ...
            /* @__PURE__ */ jsx("div", { className: "mt-5 hidden overflow-x-auto rounded-xl border border-border/60 lg:block", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
              /* @__PURE__ */ jsx("thead", { className: "bg-muted/40 text-left text-[11px] uppercase tracking-wider text-muted-foreground", children: /* @__PURE__ */ jsxs("tr", { children: [
                ...
                showTemplateStatusColumn ? /* @__PURE__ */ jsx("th", { className: "px-4 py-3 font-medium", children: templateColumnLabel }) : null,
                /* @__PURE__ */ jsx("th", { className: "px-4 py-3 font-medium", children: "Status" }),
                /* @__PURE__ */ jsx("th", { className: "px-4 py-3 font-medium", children: "Last sync" }),
              ...
              /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-border/60", children: filtered.map((c) => {
                ...
                return /* @__PURE__ */ jsxs(
                  "tr",
                  {
                    ...
                    className: cn(
                      "transition",
                      isHighlighted ? "bg-primary/10 ring-2 ring-inset ring-primary/35" : "hover:bg-muted/30"
                    ),
                    children: [
                      ...
                      showTemplateStatusColumn ? /* @__PURE__ */ jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsx(
                        ContactChannelIcons,
                        {
                          phone: c.phone,
                          email: c.email,
                      ...
                      /* @__PURE__ */ jsx("td", { className: "px-4 py-3 text-xs text-muted-foreground", children: c.lastSync }),
                      /* @__PURE__ */ jsx("td", { className: "px-4 py-3 text-right", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-1", children: [
                        c.source === "queue" && /* @__PURE__ */ jsx(
                          Button,
                          {
                            ...
                            children: syncingId === c.id ? /* @__PURE__ */ jsx(Loader2, { className: "h-3.5 w-3.5 animate-spin" }) : /* @__PURE__ */ jsxs(Fragment, { children: [
                              /* @__PURE__ */ jsx(Send, { className: "mr-1.5 h-3 w-3" }),
                              browserStorage ? "Save on device" : "Local DB"
                            ] })
                          }
                        ),
                        isLocalStorageSource(c.source) && c.status === "pending" && /* @__PURE__ */ jsx(
                          Button,
                          {
                            variant: "outline",
                            size: "sm",
              ...
              return /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  className: cn(
                    ...
                    isHighlighted ? "border-primary/50 bg-primary/10 ring-2 ring-primary/30" : "border-border/60 bg-card/40"
                  ),
                  children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "mt-3 flex flex-wrap items-center gap-2 border-t border-border/40 pt-3", children: [
                      ...
                      showTemplateStatusColumn ? /* @__PURE__ */ jsx(
                        ContactChannelIcons,
                        {
                          phone: c.phone,
                          email: c.email,
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "mt-3 flex flex-wrap gap-2", children: [
                      c.source === "queue" && /* @__PURE__ */ jsx(
                        Button,
                        {
                          ...
                          children: syncingId === c.id ? /* @__PURE__ */ jsx(Loader2, { className: "h-3.5 w-3.5 animate-spin" }) : browserStorage ? "Save on device" : "Sync to Local DB"
                        }
                      ),
                      isLocalStorageSource(c.source) && c.status === "pending" && /* @__PURE__ */ jsx(
                        Button,
                        {
                          ...
                          disabled: syncingId === c.id || isSyncingZoho,
                          className: "h-9 flex-1 min-w-[120px] rounded-lg text-xs sm:flex-none",
                          children: syncingId === c.id ? /* @__PURE__ */ jsx(Loader2, { className: "h-3.5 w-3.5 animate-spin" }) : "Save on device"
                        }
                      ),
                      /* @__PURE__ */ jsxs(
                        Button,
            ...
            /* @__PURE__ */ jsxs("div", { className: "mt-5 flex flex-col gap-2 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                "Showing ",
                filtered.length,
                " of ",
              ...
              /* @__PURE__ */ jsxs("div", { className: "hidden items-center gap-1 sm:flex", children: [
                /* @__PURE__ */ jsx(Button, { variant: "outline", size: "sm", className: "h-7 rounded-lg text-xs", children: "Previous" }),
                /* @__PURE__ */ jsx(Button, { variant: "outline", size: "sm", className: "h-7 rounded-lg text-xs", children: "Next" })
              ] })
            ] })
          ] })
        ] }),
        (pendingZohoCount > 0 || pendingQueueCount > 0) && /* @__PURE__ */ jsxs("div", { className: "fab-bottom fab-above-cookie fixed z-40 flex flex-col items-end gap-2", children: [
          pendingZohoCount > 0 && /* @__PURE__ */ jsxs(
            Button,
            {
              variant: "outline",
              onClick: () => void handleSyncAllPendingToZoho(),
              ...
              children: [
                isSyncingZoho ? /* @__PURE__ */ jsx(Loader2, { className: "mr-2 h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(Send, { className: "mr-2 h-4 w-4" }),
                /* @__PURE__ */ jsx("span", { className: "text-sm font-medium", children: "Save on device" })
              ]
            }
          ),
          pendingQueueCount > 0 && /* @__PURE__ */ jsxs(
            Button,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "text-sm font-medium", children: "Save queue" })
              ]
            }
          )
        ] })
