import { a6 as listStoredContacts } from "./router-DJrz5rEK.js";
...
async function checkForDuplicates(payload) {
  if (typeof navigator === "undefined" || navigator.onLine) {
    try {
      const { API_BASE_URL } = await import("./router-DJrz5rEK.js").then((n) => n.a8);
      const { apiFetch } = await import("./router-DJrz5rEK.js").then((n) => n.a7);
  ...
  try {
    const { getQueueItems } = await import("./router-DJrz5rEK.js").then((n) => n.a9);
