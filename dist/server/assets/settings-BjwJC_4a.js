...
import { b as getCurrentAppUser, c as apiFetch, d as API_BASE_URL, e as clearUserBrowserData, f as clearOutreachStatusForUser, i as invalidateContactsDirectory, I as Input, T as TIMEZONE_OPTIONS, B as Button, h as cn, j as loadUserSettings, D as DEFAULT_USER_SETTINGS, s as saveUserSettings, a as useConfirmModal, u as useAuth, k as getUserInitials, m as hasCookieConsent, P as PAGE, n as applyWorkModePreference, o as saveCookieConsent } from "./router-Bh1EUmi_.js";
import { C as Card, P as PageShell } from "./PageShell-HUvi-Gj1.js";
import { S as Switch } from "./switch-CK1yWGqi.js";
import { L as Label, D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogDescription, e as DialogFooter } from "./label-BadV_bVl.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-BFNQTxSA.js";
...
async function clearLocalQueueOnly() {
  const appUser = await getCurrentAppUser();
  const { clearUserSyncQueue } = await import("./router-Bh1EUmi_.js").then((n) => n.a7);
            ...
            SettingRow,
            {
              ...
              onCheckedChange: (v) => {
                ...
                if (v && typeof navigator !== "undefined" && navigator.onLine) {
                  void import("./router-Bh1EUmi_.js").then((n) => n.a8).then(
