...
import { createContext, useRef, useLayoutEffect, useEffect, useContext, useId, useCallback, useMemo, Fragment, createElement, useInsertionEffect, forwardRef, Component } from "react";
import { h as cn } from "./router-CTqOT-Nn.js";
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsx("h1", { className: "text-xl font-semibold tracking-tight sm:text-2xl md:text-3xl", children: title }),
            description && /* @__PURE__ */ jsx("p", { className: "max-w-xl text-xs text-muted-foreground sm:text-sm", children: description })
          ] }),
          actions && /* @__PURE__ */ jsx("div", { className: "w-full min-w-0 sm:w-auto", children: actions })
        ] }),
        children
      ]
    }
