...
import { Loader2, BarChart3, Users, TrendingUp, RefreshCw, Building2 } from "lucide-react";
import { P as PageShell, C as Card } from "./PageShell-HUvi-Gj1.js";
import { A as AuthGate, B as Button, c as apiFetch, d as API_BASE_URL } from "./router-Bh1EUmi_.js";
...
function InsightsPage() {
  return /* @__PURE__ */ jsx(AuthGate, { allowedRoles: ["SUPER_ADMIN", "ADMIN"], children: /* @__PURE__ */ jsx(InsightsPageInner, {}) });
}
        ...
        data.by_user.length > 0 && /* @__PURE__ */ jsxs(Card, { className: "rounded-2xl border-border/60 p-5 shadow-soft", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
            ...
            /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-border/40", children: data.by_user.map((row, i) => /* @__PURE__ */ jsxs("tr", { children: [
              /* @__PURE__ */ jsx("td", { className: "py-2 font-medium", children: row.user_name }),
              /* @__PURE__ */ jsx("td", { className: "py-2 text-muted-foreground", children: row.company_name }),
              /* @__PURE__ */ jsx("td", { className: "py-2 text-right", children: /* @__PURE__ */ jsx("span", { className: "rounded-full bg-muted px-2 py-0.5 text-xs font-semibold", children: row.count }) })
            ] }, `${row.user_name}-${i}`)) })
          ] }) })
        ] })
      ] })
